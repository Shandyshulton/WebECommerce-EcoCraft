...
<body>
    ...
    <section style="margin-top: 40px; margin-bottom: 50px;" class="container mt-5">
        <h2>Your Cart</h2>
        ...
        <table class="table cart-table">
            ...
            <tbody>
                <tr>
                    <td><img style="width: 150px" src="{{ asset('assets/images/slider/lampu sendok plastik.png') }} "
                            alt="Lampu Sendok Plastik"></td>
                    <td>Lampu Sendok Plastik</td>
                    <td>Rp. 199.000</td>
                    <td>1</td>
                    <td>Rp. 199.000</td>
                ...
                <tr>
                    <td><img style="width: 200px" src="{{ asset('assets/images/slider/kursi kardus.png') }} "
                            alt="Kursi Kardus Bekas"></td>
                    <td>Kursi Kardus Bekas</td>
                    <td>Rp. 250.000</td>
                    <td>2</td>
                    <td>Rp. 500.000</td>
                    <td><button class="btn btn-danger">Remove</button></td>
                ...
                <tr>
                    <td><img style="width: 190px"
                            src="{{ asset('assets/images/populer-products/Tas Kemasan Kopi.png') }} " alt="Produk 3">
                    </td>
                    <td>Tas</td>
                    <td>Rp. 120.000</td>
                    <td>1</td>
